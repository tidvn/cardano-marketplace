...
exports.DRepID.toAddress = (drepId) => {
    const credential = exports.DRepID.toCredential(drepId);
    return new Address_1.Address({
        paymentPart: credential,
        type: credential.type === Address_1.CredentialType.KeyHash ? Address_1.AddressType.EnterpriseKey : Address_1.AddressType.EnterpriseScript
    }).asEnterprise();
};

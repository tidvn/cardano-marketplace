...
* @returns {WasmResult}
*/
export function evaluate_tx_scripts_js(tx_hex: string, resolved_utxos: JsVecString, additional_txs: JsVecString, network: string, slot_config: string): WasmResult;
/**
